var logIn = document.querySelector('.js-login'); //nút đăng nhập trên header intro
var signUp = document.querySelector('.js-signup'); // nút đăng ký trên header intro
var modal = document.querySelector('.js-modal'); // modal chứa form đăng nhập đăng ký(toàn màn hình)
var modalContainer = document.querySelector('.js-modal-container') // phần chứa đăng nhập đăng ký
var formLogIn = document.querySelector('.auth-form:last-child'); // form đăng nhập 
var formSignUp = document.querySelector('.auth-form:first-child'); // form đăng ký
var closeForms = document.querySelectorAll('.js-auth-form__close'); // đóng các form đăng nhập đăng ký(bao gồm x và các nút thoát)
...
//     var formLogIn = document.querySelector('.js-auth-form__form');
...
var inputDangNhaps = document.querySelectorAll('.js-auth-form__input'); // các thẻ input trong form đăng nhập
var hopLe3 = false;
var hopLe4 = false;
...
var btnDangNhap = document.querySelector('.js-btn-dangnhap'); // nút đăng nhập trong form đăng nhập
btnDangNhap.onclick = function() {
    // var formLogIn = document.querySelector('.js-auth-form__form');
    formLogIn.addEventListener('submit', function(event) {
    event.preventDefault(); // Ngăn chặn hành vi mặc định của form
    ...
    if (isValidEmail && isValidPassword) {
        window.location.href = "home/home.index";
    }
});
}
...
var inputSetPasswords =  document.querySelectorAll('.js-auth-form__input-pass'); //thẻ input pass trong form đăng ký
var textSetPassNotifys = document.querySelectorAll('.invalid-password'); // thẻ chứa thông báo "mật khẩu phải gồm 8 kí tự ..."
...
var notifyErrorPass = document.querySelector('.invalid-password-not-coincidence'); // thẻ thông báo "mk ko khớp"
var btnDangKy = document.querySelector('.js-btn-signup'); // nút đăng ký trong form đăng ký
var countEqual = 0;
...
var btnDangKyNgay = document.querySelector('.js-sign-in-link'); // đăng ký ngay trong form đăng nhập
